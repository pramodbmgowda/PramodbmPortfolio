            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg-flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                      whether it’s feedback, ideas, or just a hello, I welcome your message.</p>
                ...
                <form 
                action="https://getform.io/f/bxoyemva"
                method="POST"
                className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            <input 
                                ...
                                autoComplete="email"
                                required
                                placeholder="pramodbmgowda7@gmail.com"
                                className="text-field reveal-up" 
                            />
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <textarea 
                            ...
                            id="message" 
                            placeholder="Hi!"
                            className="resize-y reveal-up text-field min-h-32 max-h-80">
                            Hi!
                        </textarea>
                    </div>
                    ...
                    <button 
                        type="submit" 
                        className="btn btn-primary [&]:max-w-full w-full justify-center reveal-up">Submit</button>
